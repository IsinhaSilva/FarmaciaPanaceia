...
public class TableClienteGUI extends javax.swing.JFrame {
    ...
    public TableClienteGUI(JTable tbCliente) {
        this.tbCliente = tbCliente;

    }
    
    public class ClienteGUI extends java.text.Format{
    ...
    private void btExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btExcluirActionPerformed
        if (tbCliente.getSelectedRow() != -1) {
            ...
            cliente.setIdCliente((int) tbCliente.getValueAt(tbCliente.getSelectedRow(), 0)); //somente id
            ClienteDAO dao = new ClienteDAO();
            dao.delete(cliente);
            leiaJTable();
        } else {
    ...
    private void btEditar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditar1ActionPerformed
        ...
        if (tbCliente.getSelectedRow() != 1) {
            ...
            for (int i = 0; i <= tbCliente.getSelectedRow(); i++) {
                //As variáveis recebem os valores da JTable

                cpf = (String) tbCliente.getValueAt(i, 1);
                cep = (String) tbCliente.getValueAt(i, 2);
                nomeCliente = (String) tbCliente.getValueAt(i, 3);
                genero = (String) tbCliente.getValueAt(i, 4);
                telefone = (String) tbCliente.getValueAt(i, 5);
                dataNasc = (String) tbCliente.getValueAt(i, 6);
                convenio = (String) tbCliente.getValueAt(i, 7);
                endRua = (String) tbCliente.getValueAt(i, 8);
                endNum = (String) tbCliente.getValueAt(i, 9);
            }
        } else {
            Cliente cliente = new Cliente();
